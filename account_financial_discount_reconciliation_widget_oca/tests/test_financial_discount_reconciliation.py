...
from odoo.addons.account_financial_discount.tests.common import TestAccountFinancialDiscountCommon
...
class TestAccountFinancialDiscountManualPayment(TestAccountFinancialDiscountCommon):
    ...
    def test_client_invoice_without_tax_bank_reconciliation(self):
        ...
        self.assertTrue(rec_widget_statement_data.get("write_off_vals"))
        # TODO Check JS widget extension
        # prop = rec_widget_statement_data.get("reconciliation_proposition")[0]
        # self.assertTrue(prop.get("financial_discount_available"))
